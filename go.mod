...
replace notkyle.org/vlrnt/scraper => ./scraper
...
require (
	...
	github.com/sunary/sqlize v0.0.0-20241127082658-347ad93742d0 // indirect
...
replace notkyle.org/vlrnt/structs => ./NotKyle/Structs/

replace notkyle.org/vlrnt/db => ./NotKyle/DB

replace notkyle.org/vlrnt/NotKyle/db => ./NotKyle/DB
